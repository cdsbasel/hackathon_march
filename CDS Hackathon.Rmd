...
Specifcally, your goal is to outperform Tom's other friends by finding a model that has the lowest mean absolute error (MAD) in order to prove to him that you are worthy of his trust. 
...
2. With the code below, load the `bbrs_train` data set and change any character variables to factors.
